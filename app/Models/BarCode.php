...
class BarCode extends Model{
    ...
    {
        return $this->hasMany(Comment::class, 'barcode_id');
    }

    public function commentsRoot(){
        return $this->hasMany(Comment::class, 'barcode_id')->where('parent_id', 0)->orderBy('id','desc');   
    }
