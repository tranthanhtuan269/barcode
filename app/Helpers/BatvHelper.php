...
$DBNAME='tohsystem';
    ...
    $sql = "INSERT IGNORE INTO barcode_dict VALUES('".$barcode->barcode."','".$barcode->name."','".$barcode->model."','".$barcode->manufacturer."','".$barcode->image."','".$barcode->avg_price."','".$barcode->spec."','".$barcode->feature."','".$barcode->description."',".time().")";
