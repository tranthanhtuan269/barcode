...
<section class="content-header">
    <h1 class="text-center font-weight-600">Danh sách các gói dịch vụ</h1>
    <div class="add-item text-center">
         <a href="{{ url('/') }}/admincp/services/create" class="btn btn-success btn-sm" title="Thêm mới page"><i class="fa fa-plus"></i> Thêm mới</a>
    </div>
</section>
    ...
    $(document).ready(function(){
        ...
        var dataObject = [
            ...
            { 
                ...
                render: function(data, type, row){
                    var html = '';
                    html += '<a href="' + baseURL + '/admincp/pages/'+ data +'/edit" class="btn-edit mr-2 edit-user" title="Sửa" style="color:#333"><i class="fa fa-edit"></i></a>';
        ...
        dataTable = $('#page-table').DataTable( {
                        ...
                        aaSorting: [],
                        stateSave: false,
                        ajax: "{{ url('/') }}/admincp/pages/getDataAjax",
                        columns: dataObject,
                        // bLengthChange: false,
                        // pageLength: 10,
                        order: [[ 3, "desc" ]],
